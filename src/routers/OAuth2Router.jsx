...
function OAuth2Router() {
    return (
        <>
            <Routes>
                <Route path="/" element={<OAuth2Page />}></Route>
                <Route path="/merge" element={<OAuth2MergePage />}></Route>
                <Route path="/signin" element={<OAuth2SigninPage />}></Route>
                <Route path="/signup" element={<OAuth2SignupPage />}></Route>
            </Routes>
        </>
    );
}
